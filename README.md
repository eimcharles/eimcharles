...
#### [Car Booking System](https://github.com/eimcharles/CarBookingSystem) (Release 2 in Progress 🚀)
#### [**Release 1: Maven application focused on core business logic, layered architecture, manual dependency injection and unit testing with AssertJ.**](https://github.com/eimcharles/CarBookingSystem/blob/main/releaseDocs/releaseOneDocs/README.md)
...
#### [**Release 2: Spring Boot modernization to support stateless authentication, persistent storage and web-integration.**](https://github.com/eimcharles/CarBookingSystem/tree/main/releaseDocs/releaseTwoDocs)
...
An interactive 3D graphics application as part of  **the Computer Graphics course (COMP 371)** at Concordia University. </br>

![OpenGL](https://img.shields.io/badge/OpenGL-4.x-blue?logo=opengl)
![GLFW](https://img.shields.io/badge/GLFW-enabled-brightgreen)
![GLEW](https://img.shields.io/badge/GLEW-included-blueviolet)
![GLM](https://img.shields.io/badge/GLM-vector%20math-orange)
![Assimp](https://img.shields.io/badge/Assimp-model%20loading-informational)
